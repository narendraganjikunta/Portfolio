    ...
    <div>
     <div className="container mt-1 computer">
      ...
      <h1 className='fw-5'>PROJECTS</h1>
         ...
         <div className='mt-5'>
       <ul className='projects d-flex text-white  justify-content-center  align-items-center '> 
         <li className='g-3'><a href="https://github.com/narendraganjikunta/Portfolio">PORTFOLIO</a></li>
         <li className='mx-3'><a href="https://github.com/narendraganjikunta/FoodDesign">FOOD DESIGN</a></li>
         <li><a href="#">ECOMMERS</a></li>
       </ul>
         </div>
     </div>
